...
namespace SistemaEstoque.Infra.Migrations
{
    ...
    [Migration("20240720214121_Add_Permissao_Categoria")]
    partial class AddPermissaoCategoria
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SistemaEstoque.Domain.Entities.PerfilAcesso", b =>
                {
                    ...
                    b.HasOne("SistemaEstoque.Domain.Entities.Permissoes.PermissaoCategoria", "PermissaoCategoria")
                        .WithOne("PerfilAcesso")
                        .HasForeignKey("SistemaEstoque.Domain.Entities.PerfilAcesso", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
